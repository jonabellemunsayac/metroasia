...
<main class="public-page">
    <section class="grid gap-6 lg:grid-cols-[420px_minmax(0,1fr)]">
        <article class="venue-card">
            <img src="<?php echo htmlspecialchars(app_url('assets/courts-preview.png')); ?>" alt="Metro Asia covered courts" class="h-[270px] w-full object-cover">
            <div class="p-5">
                ...
                <div class="mt-5 grid gap-3 text-sm font-semibold">
                    <p class="flex items-center gap-2"><i data-lucide="map-pin" class="h-4 w-4 text-primary"></i>JV Ayala Avenue Prk 1B, Tagum City, Davao del Norte</p>
                    <p class="flex items-center gap-2"><i data-lucide="phone" class="h-4 w-4 text-primary"></i>Admin desk: 09XX XXX XXXX</p>
                    <p class="flex items-center gap-2"><i data-lucide="mail" class="h-4 w-4 text-primary"></i>support@citypicklegrounds.test</p>
                </div>
            </div>
        </article>

        <section class="grid content-start gap-5">
            <form class="public-card p-6" action="mailto:support@citypicklegrounds.test" method="post" enctype="text/plain">
                ...
                <label class="mt-4 grid gap-2 text-sm font-bold">Reservation concern
                    <select name="concern" class="form-select">
                        ...
                        <option>Open play question</option>
